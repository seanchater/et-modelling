...
def swets_filter(data, do_interpolate=True, axis=2, invert=False):
    ...
    NDVI raster time-series. Each image in time-series is shape y,x. Images are stacked along t (time dimension)
    ...
    :param invert: bool
    Inversion of the data and output. This is useful for albedo where bad clouds masking will force the values up,
