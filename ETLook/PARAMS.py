...
class PARAMS:
    def __init__(self, input_path, output_path, input_dates:None):
        ...
        self.parDictIN = {
            ...
            "dem" : os.path.join(os.path.join(input_path, "DEM_DERIVATIVES/"), "DEM_AOI.tif"),
            "slope" : os.path.join(os.path.join(input_path, "DEM_DERIVATIVES/"), "Slope_AOI.tif"),
            "aspect" : os.path.join(os.path.join(input_path, "DEM_DERIVATIVES/"), "Aspect_AOI.tif"),
        ...
        self.parDictOUT = {
            "vc" : os.path.join(output_path, "vc_%s.tif" %input_dates),
